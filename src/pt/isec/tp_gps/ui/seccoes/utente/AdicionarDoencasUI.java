...
public class AdicionarDoencasUI extends BorderPane {
    Decorator model;
    Label lbNome;
    TextField tfNome;
    Button apply, cancel;
    ...
    public AdicionarDoencasUI(Decorator model) {
        this.model = model;
        createViews();
        registerHandlers();
        update();
    ...
    private void registerHandlers() {
        ...
        apply.setOnAction(event -> {
            model.addTempDoenca(tfNome.getText().trim());
            model.updateUI();
        });
